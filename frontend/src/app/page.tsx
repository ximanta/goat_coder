...
const Page = () => {
  ...
  const categories = [
    { icon: <Code className="w-6 h-6" />, name: 'Language Fundamentals', count: '150+ Problems', value: 'fundamentals' },
    { icon: <BookOpen className="w-6 h-6" />, name: 'Data Structures', count: '200+ Problems', value: 'data_structures' },
    { icon: <Brain className="w-6 h-6" />, name: 'Algorithms', count: '180+ Problems', value: 'algorithms' },
    { icon: <Zap className="w-6 h-6" />, name: 'Problem Solving', count: '120+ Problems', value: 'problem_solving' }
  ];
